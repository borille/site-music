...
var pathToImages = 'http://expedicionario:81/Geral/calendario/images/';
...
switch(languageCode){
	case "en":	/* English */
		var monthArray = ['Janeiro','Fevereiro','Mar�o','Abril','Maio','Junho','Julho','Agosto','Setembro','Outubro','Novembro','Dezembro'];
